...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { id: 'symptom', label: 'Symptom', path: '/symptom-checker', icon: 'symptom' },
    { id: 'hospital', label: 'Hospital', path: '/find-hospital', icon: 'hospital' },
    { id: 'doctors', label: 'Doctors', path: '/doctor-listing', icon: 'doctor' },
      ...
      <header className="desktop-header">
        <div className="header-content">
          ...
          <div className="auth-section">
            <button className="login-btn" onClick={() => navigate('/auth-choice')}>
              Login
            </button>
            <button className="signup-btn" onClick={() => navigate('/auth-choice')}>
              Sign Up
            </button>
          </div>
        </div>
