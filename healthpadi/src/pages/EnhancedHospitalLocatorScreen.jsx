      ...
      {mapView === 'list' ? (
        <div className="hospital-list">
          {filteredHospitals.map(hospital => (
            <Card key={hospital.id} variant="elevated" className="hospital-card">
                ...
                <div className="hospital-services">
                  ...
                  <div className="services-tags">
                    ...
                    {hospital.services.length > 3 && (
                      <span className="service-tag">+{hospital.services.length - 3} more</span>
                    )}
                  </div>
                </div>
        ...
        <div className="map-view-container">
          <div className="map-placeholder">
            ...
            <p>Hospital locations would be displayed on an interactive map in a production environment</p>
          ...
          <div className="map-sidebar">
            ...
            {filteredHospitals.map(hospital => (
              <Card key={hospital.id} variant="outlined" className="sidebar-hospital-card">
        ...
        <div className="hospital-detail-overlay" onClick={closeHospitalDetails}>
          <div className="hospital-detail-modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <Button variant="icon" onClick={closeHospitalDetails} className="close-button">
                <Icon name="close" />
              </Button>
            </div>
            ...
            <div className="modal-content">
              <div className="hospital-detail-content">
                <div className="detail-section">
                  <h3><Icon name="location" /> Address</h3>
                  <p>{selectedHospital.address}</p>
                </div>
                
                <div className="detail-section">
                  <h3><Icon name="phone" /> Contact</h3>
                ...
                <div className="detail-section">
                  <h3><Icon name="services" /> Services</h3>
                ...
                <div className="detail-section">
                  <h3><Icon name="info" /> Current Information</h3>
                  <div className="info-grid">
                    ...
                    <div className="info-item">
                      ...
                      <span className="info-value">{selectedHospital.distance}</span>
                    </div>
                    <div className="info-item">
                      <span className="info-label">Wait Time:</span>
                      <span className="info-value">{selectedHospital.waitTime}</span>
                    </div>
                  </div>
                </div>
