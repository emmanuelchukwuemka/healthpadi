              ...
              <div className="detail-section">
                ...
                <div className="detail-grid">
                  <div className="detail-item">
                    ...
                    <span className="detail-value">{user.emergencyContact.name}</span>
                  </div>
                  <div className="detail-item">
                    <span className="detail-label">Relationship</span>
                    <span className="detail-value">{user.emergencyContact.relationship}</span>
                  </div>
                  <div className="detail-item">
                    <span className="detail-label">Phone</span>
                    <span className="detail-value">{user.emergencyContact.phone}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="appointments-content">
          ...
          <div className="appointments-list">
            {appointments.map(appointment => (
              <Card key={appointment.id} variant="elevated" className="appointment-card">
