                ...
                <div className="guide-header">
                  ...
                  <div className="guide-info">
                    ...
                    <div className="guide-meta">
                      ...
                      <Badge 
                        variant={guide.severity === 'Critical' ? 'danger' : guide.severity === 'High' ? 'warning' : 'info'}
        ...
        <div className="guide-modal-overlay" onClick={closeGuide}>
          <div className="guide-modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <Button variant="icon" onClick={closeGuide} className="close-button">
                <Icon name="close" />
              </Button>
            </div>
            ...
            <div className="modal-content">
              <div className="guide-details">
                <div className="guide-meta">
                  ...
                  <Badge 
                    variant={selectedGuide.severity === 'Critical' ? 'danger' : selectedGuide.severity === 'High' ? 'warning' : 'info'}
                    className="severity-badge"
                  >
                ...
                <div className="emergency-warning">
                  <Icon name="warning" />
                  <p><strong>Warning:</strong> These are general guidelines. Always call emergency services for life-threatening situations.</p>
                </div>
